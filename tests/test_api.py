...
def test_meta_knowledge_graph():
    ...
    edge_tuples_expected = {
        ...
        ("biolink:Protein", "biolink:enables", "biolink:Pathway", ""),
        ...
        ("biolink:Protein", "biolink:causes", "biolink:AnatomicalEntity", ""),
        (
            "biolink:Gene",
            "biolink:actively_involved_in",
            "biolink:MolecularActivity",
        ...
        ("biolink:ChemicalEntity", "biolink:precedes", "biolink:BiologicalProcess", ""),
        (
            "biolink:MolecularActivity",
            "biolink:has_input",
            "biolink:MolecularMixture",
        ...
        ("biolink:Pathway", "biolink:enabled_by", "biolink:Protein", ""),
        (
            "biolink:SmallMolecule",
            "biolink:interacts_with",
            "biolink:CellularComponent",
        ...
        ("biolink:Protein", "biolink:capable_of", "biolink:Pathway", ""),
        ...
        ("biolink:Disease", "biolink:has_input", "biolink:AnatomicalEntity", ""),
        ...
        ("biolink:SmallMolecule", "biolink:precedes", "biolink:BiologicalProcess", ""),
        ...
        ("biolink:Protein", "biolink:causes", "biolink:OrganismTaxon", ""),
        (
            "biolink:Gene",
            "biolink:acts_upstream_of_or_within",
            "biolink:BiologicalProcess",
